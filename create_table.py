...
myCursor.execute("CREATE TABLE POTROSNJA_BROJILA(REDNI_BROJ int PRIMARY KEY NOT NULL AUTO_INCREMENT, ID int NOT NULL, POSTROSNJA int NOT NULL, MESEC VARCHAR(50) NOT NULL)")
